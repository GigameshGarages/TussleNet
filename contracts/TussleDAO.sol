...
contract TussleDAO {
    ...
    struct Campaign {
        ...
        mapping (address => TussleNetwork) TussleGroups;
    ...
    function newCampaign(
        ...
        c.TussleGroups[msg.sender] = TussleNetwork(msg.sender, msg.value);
    ...
    function follow(uint256 _campaignID)
        ...
        Campaign storage c = campaigns[_campaignID];
        TussleNetwork storage TussleNode = c.TussleGroups[msg.sender];
        return followCampaign(_campaignID, c, TussleNode);
    }
    ...
    function returnBounty(Campaign storage c)
        ...
        uint256 bountypot = c.TussleGroups[msg.sender].bountypot;
        c.TussleGroups[msg.sender].bountypot = 0;
